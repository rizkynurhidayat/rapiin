                    ...
                    <div class="card-body">
                      <form action="{{route('opsi.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">  
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="subtitle" name="subtitle" placeholder="Input Subtitle"/>
                            </div>
                        </div>                                                                                                                                                                                                                                                                          
                        <div class="row mb-3">  
                            <label class="col-sm-2 col-form-label" for="button">Button</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="button" name="button" placeholder="Input Button"/>
                            </div>
